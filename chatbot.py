...
def main():
    ...
    if choice == 'Home':
        ...
        st.header("About")
        st.markdown("""Welcome to Zaid's Chatbot Project""")
        
        st.markdown("""##This project aims to create an intelligent virtual assistant using cutting-edge Natural Language Processing (NLP) techniques. Our chatbot leverages a Logistic Regression model for accurate and meaningful interactions, while Streamlit provides a sleek and user-friendly interface.""")

        st.subheader("Project Overview")
        st.markdown("""**Natural Language Processing**: Our chatbot is trained using advanced NLP techniques and the Logistic Regression algorithm to understand and respond to user queries effectively.
        ...
        st.html('''This project is a foundational step towards creating a more sophisticated virtual assistant. Future enhancements may include:
